# python 04-distilabel_with_Q.py --url http://127.0.0.1:8000/v1 --dataset c00cjz00/Medical-R1-Distill-Data --datasetconfig default --datasetsplit train --questioncolumn question --model Qwen/QwQ-32B --page 5 --pagesize 64 --batchsize 64 --temperature 0.6 --maxnewtokens 4096 --template CUSTOM_TEMPLATE01
# python 04-distilabel_with_Q.py --url http://127.0.0.1:8000/v1 --dataset c00cjz00/Medical-R1-Distill-Data --questioncolumn question --model Qwen/QwQ-32B --page 5 --pagesize 64 
...
# 請依照您輸入的 questioncolumn 手動修改欄位名稱{{ question }}
CUSTOM_TEMPLATE01 = '''
You will be given a problem. Please analyze the problem step by step and provide your final answer in **Traditional Chinese (zh-TW) from a Taiwanese perspective** while following these guidelines: 
...
def run_pipeline(url, dataset, datasetconfig, datasetsplit, questioncolumn, model, page, pagesize, batchsize, temperature, maxnewtokens, templatename):
    # 根據傳入的模板名稱獲取具體模板內容
...
if __name__ == "__main__":
    ...
    run_pipeline(url, dataset, datasetconfig, datasetsplit, questioncolumn, model, page, pagesize, batchsize, temperature, maxnewtokens, templatename)
